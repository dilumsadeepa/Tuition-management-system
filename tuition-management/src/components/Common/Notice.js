...
function Notice() {
  ...
  const validationSchema = Yup.object({
    ...
    noticeTitle: Yup.string().min(3).max(255).required(),
    noticeDescription: Yup.string().required(),
    files: Yup.mixed()
          ...
          <Formik initialValues={initialValues} onSubmit={onSubmit} validationSchema={validationSchema}>
            ...
            <Form className="formContainer">
              <div class="mb-3 mt-3">
                ...
                <ErrorMessage name="audience" component="span" className="badge text-bg-danger" />
                <Field
                as="select"
                  id="inputAudience"
              ...
              <div class="mb-3 mt-3">
                ...
                <ErrorMessage name="noticeTitle" component="span" className="badge text-bg-danger" />
                <Field
                  id="inputNoticeTitle"
                  className="form-control"
                  name="noticeTitle"
              ...
              <div class="mb-3 mt-3">
                ...
                <ErrorMessage name="noticeDescription" component="span" className="badge text-bg-danger" />
                <Field
                  as="textarea"
